...
<body id="page-top">
    ...
    <div class="contact-clean">
        ...
        if($fhe=='yes'){
            ...
            <div class='card card-style-table'>
                <div class='form-group'><label>No. of FHE Beneficiaries Who Opted Out of FHE</label>
                    ...
                    echo"
                        <label>1st Term</label><input id='total_fhe_opt_out_1st' name='total_fhe_opt_out_1st' class='form-control' type='number' value='$total_fhe_opt_out_1st' required='' min='0' readonly></div>";
                        ...
                        <div class='col-12 col-md-3 col-xl-6'>";
                    echo"
                        <label>2nd Term</label><input id='total_fhe_opt_out_2nd' name='total_fhe_opt_out_2nd' class='form-control' type='number' value='$total_fhe_opt_out_2nd' required='' min='0' readonly></div>";
                        ...
                        if($ac_calendar=='Trimester' OR $ac_calendar=='Trimester with Summer'){
                            if( $ac_calendar=='Trimester with Summer'){
                                ...
                                <div class='col-12 col-md-3 col-xl-6'>";
                        echo"
                        <label>3rd Term</label><input id='total_fhe_opt_out_3rd' name='total_fhe_opt_out_3rd' class='form-control' type='number' value='$total_fhe_opt_out_3rd' required='' min='0' readonly></div>";
                        }
                        ...
                        if($ac_calendar=='Semester with Summer' OR $ac_calendar=='Trimester with Summer'){
                            if( $ac_calendar=='Trimester with Summer'){
                                ...
                                <div class='col-12 col-md-3 col-xl-6'>";
                        echo"
                        <label>Summer/Midyear</label><input id='total_fhe_opt_out_summer_midyear' name='total_fhe_opt_out_summer_midyear' class='form-control' type='number' value='$total_fhe_opt_out_summer_midyear' required='' min='0' readonly></div>";
                        }
                echo"
                    </div>
                </div>
                <div class='form-group'><label>No. of FHE Beneficiaries Who Voluntarily Contributed for FHE</label>
                    <div class='form-row'>";
                        ...
                        <div class='col-12 col-md-3 col-xl-6'>";
                    echo"
                        <label>1st Term</label><input id='total_fhe_vol_cont_1st' name='total_fhe_vol_cont_1st' class='form-control' type='number' value='$total_fhe_vol_cont_1st' required='' min='0' readonly></div>";
                        ...
                        <div class='col-12 col-md-3 col-xl-6'>";
                    echo"
                        <label>2nd Term</label><input id='total_fhe_vol_cont_2nd' name='total_fhe_vol_cont_2nd' class='form-control' type='number' value='$total_fhe_vol_cont_2nd' required='' min='0' readonly></div>";
                        ...
                        if($ac_calendar=='Trimester' OR $ac_calendar=='Trimester with Summer'){
                            if( $ac_calendar=='Trimester with Summer'){
                                ...
                                <div class='col-12 col-md-3 col-xl-6'>";
                        echo"
                        <label>3rd Term</label><input id='total_fhe_vol_cont_3rd' name='total_fhe_vol_cont_3rd' class='form-control' type='number' value='$total_fhe_vol_cont_3rd' required='' min='0' readonly></div>";
                        }
                        ...
                        if($ac_calendar=='Semester with Summer' OR $ac_calendar=='Trimester with Summer'){
                            if( $ac_calendar=='Trimester with Summer'){
                                ...
                                <div class='col-12 col-md-3 col-xl-6'>";
                        echo"
                        <label>Summer/Midyear</label><input id='total_fhe_vol_cont_summer_midyear' name='total_fhe_vol_cont_summer_midyear' class='form-control' type='number' value='$total_fhe_vol_cont_summer_midyear' required='' min='0' readonly></div>";
                        }
                ...
                <div class='form-group'><label>No. of FHE Beneficiaries on Leave of Absence (LOA)</label>
                    <div class='form-row'>";
                        ...
                        echo"<label>1st Term</label><input id='total_fhe_loa_1st' name='total_fhe_loa_1st' class='form-control' type='number' value='$total_fhe_loa_1st' required='' min='0' readonly></div>";
                        ...
                        echo"<label>2nd Term</label><input id='total_fhe_loa_2nd' name='total_fhe_loa_2nd' class='form-control' type='number' value='$total_fhe_loa_2nd' required='' min='0' readonly></div>";
                        ...
                        if($ac_calendar=='Trimester' OR $ac_calendar=='Trimester with Summer'){
                            if( $ac_calendar=='Trimester with Summer'){
                                ...
                                <div class='col-12 col-md-3 col-xl-6'>";
                        echo"
                        <label>3rd Term</label><input id='total_fhe_loa_3rd' name='total_fhe_loa_3rd' class='form-control' type='number' value='$total_fhe_loa_3rd' required='' min='0' readonly></div>";
                        }
                        ...
                        if($ac_calendar=='Semester with Summer' OR $ac_calendar=='Trimester with Summer'){
                            if( $ac_calendar=='Trimester with Summer'){
                                ...
                                <div class='col-12 col-md-3 col-xl-6'>";
                        echo"
                        <label>Summer/Midyear</label><input id='total_fhe_loa_summer_midyear' name='total_fhe_loa_summer_midyear' class='form-control' type='number' value='$total_fhe_loa_summer_midyear' required='' min='0' readonly></div>";
                        }
                    ...
                    <div class='form-group'> 
                            <div class='form-row'>
                                <div class='col-12 col-md-3 col-xl-12'>
                                    ...
                                    echo" readonly><label class='custom-control-label' for='fhe_dropouts'>With students who dropped out under Free Higher Education?</label>
                                </div>
                            </div>";
        ...
        echo"<div class='card card-style-out'>
            <div class='card card-style-table'>
                <div class='form-group'><label class='label-parts'>II.B TERTIARY EDUCATION SUBSIDY</label></div>
                <div class='form-group'><label>How many students applied for Tertiary Education Subsidy?</label><input id='total_tes_applicant' name='total_tes_applicant' class='form-control' type='number' min='0' value='$total_tes_applicant' required='' readonly></div>
                <div class='form-group'>
            ...
            <div class='card card-style-table'>
                <div class='form-group'>
                    <label>Total No. of TES Grantees on Leave of Absence (LOA)</label>
                        <div class='form-row'>
                            <div class='col-12 col-md-3 col-xl-6'>
                                <label>1st Semester</label>
                                <input id='total_tes_loa_1st' name='total_tes_loa_1st' class='form-control' type='number' value='$total_tes_loa_1st' required='' min='0' readonly>
                            </div>
                            <div class='col-12 col-md-3 col-xl-6'>
                                <label>2nd Semester</label>
                                <input id='total_tes_loa_2nd' name='total_tes_loa_2nd' class='form-control' type='number' value='$total_tes_loa_2nd' required='' min='0' readonly>
                            </div>
                        </div>
                    </div>
                    <div class='form-group'>
                        <div class='form-row'>
                            <div class='col-12 col-md-3 col-xl-12'>
                                <div class='custom-control custom-checkbox'>
                                    ...
                                    echo" readonly><label class='custom-control-label' for='tes_dropouts'>With students who dropped out under Tertiary Education Subsidy?</label>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        echo"<div class='card card-style-out'>
            ...
            <div class='card card-style-table'>
                <div class='form-group'><label>Total No. of TDP Grantees on Leave of Absence (LOA)</label>
                    <div class='form-row'>
                        <div class='col-12 col-md-3 col-xl-6'><label>1st Semester</label><input id='total_tdp_loa_1st' name='total_tdp_loa_1st' class='form-control' type='number' value='$total_tdp_loa_1st' required='' min='0' readonly></div>
                        <div class='col-12 col-md-3 col-xl-6'><label>2nd Semester</label><input  id='total_tdp_loa_2nd' name='total_tdp_loa_2nd' class='form-control' type='number' value='$total_tdp_loa_2nd' required='' min='0' readonly></div>
                    </div>
                </div>
                ...
                <div class='form-row'>
                    <div class='col-12 col-md-3 col-xl-12'>
                        <div class='custom-control custom-checkbox'>
                            ...
                            echo" readonly><label class='custom-control-label' for='tdp_dropouts'>With students who dropped out under Tulong Dunong Program?</label>
                        </div>
                    </div>
                </div>
            </div>

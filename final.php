...
<body id="page-top">
    ...
    <div class="contact-clean">
        <form id="hei-final">
        <?php
            echo "<iframe src='assets/pdf/". $_SESSION['hei_name'] . "-" . $_SESSION['ac_year'] . ".pdf' frameborder='0' style='overflow:hidden;overflow-x:hidden;overflow-y:hidden;height:100%;width:100%;left:0px;right:0px;bottom:0px' height='100%' width='100%'></iframe>"
        ?>
        </form>
    </div>

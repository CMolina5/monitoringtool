...
<thead>
<tr>
    <th class='text-center' rowspan='2' style='background-color: #3C70AB; color:#ffff;'><input type='checkbox' name='main_tdp_dropouts_checkbox'></th>
...
";
    ...
    if ($resultCheck > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "
        <tr>
            <td class='text-center'><input type='checkbox' id='$uid' name='tdp_dropouts_checkbox' value='$uid'></td>

...
echo "
<table id='tbl_tdp_dropouts' class='table-bordered tbl-style stripe' style='width: 100%;'>
    <thead>
        <tr>
...
if ($resultCheck > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        <tr>
            ...
            <button class='btn btn-info edit_dropouts_tdp' data-bs-tooltip='' type='button' title='Edit' name='edit' value='edit' id='$uid'><i class='far fa-edit'></i></button>
            <button class='btn btn-danger btn-table-margin remove_dropouts_tdp' data-bs-tooltip='' type='button' title='Remove' name='remove' value='remove' id='$uid'><i class='fas fa-trash'></i></button>
            </td>
        </tr>
            ";
    }

                ...
                <div class="modal-body">
                        ...
                        <div class="form-row">
                            <div class="col" data-toggle="tooltip" title="male">
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text icon-container"><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div><input id="fhe_drop_1st_male" name="fhe_drop_1st_male" class="form-control" type="number" min="0" />
                                </div>
                            </div>
                            <div class="col" data-toggle="tooltip" title="female">
                                <div class='input-group'>
                                    <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div><input id="fhe_drop_1st_female" name="fhe_drop_1st_female" class="form-control" type="number" min="0" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="col" data-toggle="tooltip" title="male">
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text icon-container"><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div><input id="fhe_drop_2nd_male" name="fhe_drop_2nd_male" class="form-control" type="number" min="0" />
                                </div>
                            </div>
                            <div class="col" data-toggle="tooltip" title="female">
                                <div class='input-group'>
                                    <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div><input id="fhe_drop_2nd_female" name="fhe_drop_2nd_female" class="form-control" type="number" min="0" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="col" data-toggle="tooltip" title="male">
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text icon-container"><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div><input id="fhe_loa_1st_male" name="fhe_loa_1st_male" class="form-control" type="number" min="0" />
                                </div>
                            </div>
                            <div class="col" data-toggle="tooltip" title="female">
                                <div class='input-group'>
                                    <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div><input id="fhe_loa_1st_female" name="fhe_loa_1st_female" class="form-control" type="number" min="0" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="col" data-toggle="tooltip" title="male">
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text icon-container"><i class="fas fa-male" style="font-size:20px; color:#1a5676"></i></span></div><input id="fhe_loa_2nd_male" name="fhe_loa_2nd_male" class="form-control" type="number" min="0" />
                                </div>
                            </div>
                            <div class="col" data-toggle="tooltip" title="female">
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text icon-container"><i class="fas fa-female" style="font-size:20px; color:#9a0694"></i></span></div><input id="fhe_loa_2nd_female" name="fhe_loa_2nd_female" class="form-control" type="number" min="0" />
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-content">
            <form method="POST" id='add_loa_tes_form'>
                ...
                <div class="modal-body">
                    ...
                    <div id="div_tes_others_loa" name="div_tes_others_loa" class="form-group d-none">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="col" data-toggle="tooltip" title="male">
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text icon-container"><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div><input id="tes_loa_1st_male" name="tes_loa_1st_male" class="form-control" type="number" min="0" />
                                </div>
                            </div>
                            <div class="col" data-toggle="tooltip" title="female">
                                <div class='input-group'>
                                    <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div><input id="tes_loa_1st_female" name="tes_loa_1st_female" class="form-control" type="number" min="0" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="col" data-toggle="tooltip" title="male">
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text icon-container"><i class="fas fa-male" style="font-size:20px; color:#1a5676"></i></span></div><input id="tes_loa_2nd_male" name="tes_loa_2nd_male" class="form-control" type="number" min="0" />
                                </div>
                            </div>
                            <div class="col" data-toggle="tooltip" title="female">
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text icon-container"><i class="fas fa-female" style="font-size:20px; color:#9a0694"></i></span></div><input id="tes_loa_2nd_female" name="tes_loa_2nd_female" class="form-control" type="number" min="0" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    if ($ac_calendar == 'Trimester' or $ac_calendar == 'Trimester with Summer') {
                        ...
                        <div class="form-row">
                            <div class="col" data-toggle="tooltip" title="male">
                                <div class="input-group"><div class="input-group-prepend"><span class="input-group-text icon-container"><i class="fas fa-male" style="font-size:20px; color:#1a5676"></i></span></div><input id="tes_loa_3rd_male" name="tes_loa_3rd_male" class="form-control" type="number" min="0" />
                                </div>
                            </div>
                            <div class="col" data-toggle="tooltip" title="female">
                                <div class="input-group"><div class="input-group-prepend"><span class="input-group-text icon-container"><i class="fas fa-female" style="font-size:20px; color:#9a0694"></i></span></div><input id="tes_loa_3rd_female" name="tes_loa_3rd_female" class="form-control" type="number" min="0" />
                                </div>
                            </div>
                        </div>
                        </div>
                    ...
                    if ($ac_calendar == 'Semester with Summer' or $ac_calendar == 'Trimester with Summer') {
                        ...
                        <label>Summer/Midyear</label>
                            <div class="form-row">
                                <div class="col" data-toggle="tooltip" title="male">
                                    <div class="input-group"><div class="input-group-prepend"><span class="input-group-text icon-container"><i class="fas fa-male" style="font-size:20px; color:#1a5676"></i></span></div><input id="tes_loa_summer_midyear_male" name="tes_loa_summer_midyear_male" class="form-control" type="number" min="0" />
                                    </div>
                                </div>
                                <div class="col" data-toggle="tooltip" title="female">
                                    <div class="input-group"><div class="input-group-prepend"><span class="input-group-text icon-container"><i class="fas fa-female" style="font-size:20px; color:#9a0694"></i></span></div><input id="tes_loa_summer_midyear_female" name="tes_loa_summer_midyear_female" class="form-control" type="number" min="0" />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="col" data-toggle="tooltip" title="male">
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text icon-container"><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div><input id="tdp_loa_1st_male" name="tdp_loa_1st_male" class="form-control" type="number" min="0" />
                                </div>
                            </div>
                            <div class="col" data-toggle="tooltip" title="female">
                                <div class='input-group'>
                                    <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div><input id="tdp_loa_1st_female" name="tdp_loa_1st_female" class="form-control" type="number" min="0" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="col" data-toggle="tooltip" title="male">
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text icon-container"><i class="fas fa-male" style="font-size:20px; color:#1a5676"></i></span></div><input id="tdp_loa_2nd_male" name="tdp_loa_2nd_male" class="form-control" type="number" min="0" />
                                </div>
                            </div>
                            <div class="col" data-toggle="tooltip" title="female">
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text icon-container"><i class="fas fa-female" style="font-size:20px; color:#9a0694"></i></span></div><input id="tdp_loa_2nd_female" name="tdp_loa_2nd_female" class="form-control" type="number" min="0" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    if ($ac_calendar == 'Trimester' or $ac_calendar == 'Trimester with Summer') {
                        ...
                        <div class="form-row">
                            <div class="col" data-toggle="tooltip" title="male">
                                <div class="input-group"><div class="input-group-prepend"><span class="input-group-text icon-container"><i class="fas fa-male" style="font-size:20px; color:#1a5676"></i></span></div><input id="tdp_loa_3rd_male" name="tdp_loa_3rd_male" class="form-control" type="number" min="0" />
                                </div>
                            </div>
                            <div class="col" data-toggle="tooltip" title="female">
                                <div class="input-group"><div class="input-group-prepend"><span class="input-group-text icon-container"><i class="fas fa-female" style="font-size:20px; color:#9a0694"></i></span></div><input id="tdp_loa_3rd_female" name="tdp_loa_3rd_female" class="form-control" type="number" min="0" />
                                </div>
                            </div>
                        </div>
                        </div>
                    ...
                    if ($ac_calendar == 'Semester with Summer' or $ac_calendar == 'Trimester with Summer') {
                        ...
                        <label>Summer/Midyear</label>
                            <div class="form-row">
                                <div class="col" data-toggle="tooltip" title="male">
                                    <div class="input-group"><div class="input-group-prepend"><span class="input-group-text icon-container"><i class="fas fa-male" style="font-size:20px; color:#1a5676"></i></span></div><input id="tdp_loa_summer_midyear_male" name="tdp_loa_summer_midyear_male" class="form-control" type="number" min="0" />
                                    </div>
                                </div>
                                <div class="col" data-toggle="tooltip" title="female">
                                    <div class="input-group"><div class="input-group-prepend"><span class="input-group-text icon-container"><i class="fas fa-female" style="font-size:20px; color:#9a0694"></i></span></div><input id="tdp_loa_summer_midyear_female" name="tdp_loa_summer_midyear_female" class="form-control" type="number" min="0" />
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-content">
            <form method="POST" id="add_dropouts_tes_form">
                ...
                <div class="modal-body">
                    ...
                    <div id="div_tes_others" name="div_tes_others" class="form-group d-none">
                        <label>If other reason please specify:</label>
                        <input id="tes_drop_other" name="tes_drop_other" class="form-control" type="text">
                    </div>
                    <hr>
                    <div class="form-group"><label>No. of Dropouts</label></div>
                    <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="col" data-toggle="tooltip" title="male">
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text icon-container"><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div><input id="tes_drop_1st_male" name="tes_drop_1st_male" class="form-control" type="number" min="0" />
                                </div>
                            </div>
                            <div class="col" data-toggle="tooltip" title="female">
                                <div class='input-group'>
                                    <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div><input id="tes_drop_1st_female" name="tes_drop_1st_female" class="form-control" type="number" min="0" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="col" data-toggle="tooltip" title="male">
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text icon-container"><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div><input id="tes_drop_2nd_male" name="tes_drop_2nd_male" class="form-control" type="number" min="0" />
                                </div>
                            </div>
                            <div class="col" data-toggle="tooltip" title="female">
                                <div class='input-group'>
                                    <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div><input id="tes_drop_2nd_female" name="tes_drop_2nd_female" class="form-control" type="number" min="0" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    if ($ac_calendar == 'Trimester' or $ac_calendar == 'Trimester with Summer') {
                        ...
                        <div class="form-row">
                            <div class="col" data-toggle="tooltip" title="male">
                                <div class="input-group"><div class="input-group-prepend"><span class="input-group-text icon-container"><i class="fas fa-male" style="font-size:20px; color:#1a5676"></i></span></div><input id="tes_drop_3rd_male" name="tes_drop_3rd_male" class="form-control" type="number" min="0" />
                                </div>
                            </div>
                            <div class="col" data-toggle="tooltip" title="female">
                                <div class="input-group"><div class="input-group-prepend"><span class="input-group-text icon-container"><i class="fas fa-female" style="font-size:20px; color:#9a0694"></i></span></div><input id="tes_drop_3rd_female" name="tes_drop_3rd_female" class="form-control" type="number" min="0" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    if ($ac_calendar == 'Semester with Summer' or $ac_calendar == 'Trimester with Summer') {
                        ...
                        <div class="form-row">
                            <div class="col" data-toggle="tooltip" title="male">
                                <div class="input-group"><div class="input-group-prepend"><span class="input-group-text icon-container"><i class="fas fa-male" style="font-size:20px; color:#1a5676"></i></span></div><input id="tes_drop_summer_midyear_male" name="tes_drop_summer_midyear_male" class="form-control" type="number" min="0" />
                                </div>
                            </div>
                            <div class="col" data-toggle="tooltip" title="female">
                                <div class="input-group"><div class="input-group-prepend"><span class="input-group-text icon-container"><i class="fas fa-female" style="font-size:20px; color:#9a0694"></i></span></div><input id="tes_drop_summer_midyear_female" name="tes_drop_summer_midyear_female" class="form-control" type="number" min="0" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="col" data-toggle="tooltip" title="male">
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text icon-container"><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div><input id="total_fhe_1st_male" name="total_fhe_1st_male" class="form-control" type="number" min="0" placeholder="0">
                                </div>
                            </div>

                            <div class="col" data-toggle="tooltip" title="female">
                                <div class='input-group'>
                                    <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div><input id="total_fhe_1st_female" name="total_fhe_1st_female" class="form-control" type="number" min="0" placeholder="0">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="col" data-toggle="tooltip" title="male">
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text icon-container"><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div><input id="total_fhe_2nd_male" name="total_fhe_2nd_male" class="form-control" type="number" min="0" placeholder="0">
                                </div>
                            </div>
                            <div class="col" data-toggle="tooltip" title="female">
                                <div class='input-group'>
                                    <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div><input id="total_fhe_2nd_female" name="total_fhe_2nd_female" class="form-control" type="number" min="0" placeholder="0">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <form method="POST" id="add_program_tes_form">
                ...
                <div class="modal-body">
                    <div class="form-group"><label>Degree Program</label>
                        <select name="tes_program_name" id="tes_program_name" class="form-control" required>
                            <option selected disabled value="">--- Select Degree Program ---</option>
                            <?php
                            $sql = "SELECT * FROM tbl_degree_programs WHERE hei_uii='$_SESSION[hei_uii]' AND ac_year='$_SESSION[ac_year]' AND (total_tes_exceeded_mrr_male = 0 AND total_tes_exceeded_mrr_female = 0) AND (total_tes_est_grad_male = 0 AND total_tes_est_grad_female = 0)";
                            $result = mysqli_query($conn, $sql);
                            $resultCheck = mysqli_num_rows($result);
                    ...
                    <div class="form-group"><label>No. of TES Grantees who exceeded the maximum residency rule</label>
                        <div class="form-row">
                            <div class="col" data-toggle="tooltip" title="male">
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text icon-container"><i class="fas fa-male" style="font-size:20px; color:#1a5676"></i></span></div><input name="total_tes_mrr_male" id="total_tes_mrr_male" class="form-control" type="number" min="0">
                                </div>
                            </div>
                            <div class="col" data-toggle="tooltip" title="female">
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text icon-container"><i class="fas fa-female" style="font-size:20px; color:#9a0694"></i></span></div><input name="total_tes_mrr_female" id="total_tes_mrr_female" class="form-control" type="number" min="0">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group"><label>Estimated No. of Graduating Students</label>
                        <div class="form-row">
                            <div class="col" data-toggle="tooltip" title="male">
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text icon-container"><i class="fas fa-male" style="font-size:20px; color:#1a5676"></i></span></div><input name="total_tes_est_grad_male" id="total_tes_est_grad_male" class="form-control" type="number" min="0">
                                </div>
                            </div>
                            <div class="col" data-toggle="tooltip" title="female">
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text icon-container"><i class="fas fa-female" style="font-size:20px; color:#9a0694"></i></span></div><input name="total_tes_est_grad_female" id="total_tes_est_grad_female" class="form-control" type="number" min="0">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col border-right" data-toggle="tooltip" title="female">
                                <div class="input-group">
                                    ...
                                    <input id="total_tes_2nd_female" name="total_tes_2nd_female" class="form-control" type="number" min="0">
                                </div>
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col" data-toggle="tooltip" title="male">
                                <div class="input-group">
                                    ...
                                    <input id="total_pwd_1st_male" name="total_pwd_1st_male" class="form-control" type="number" min="0">
                                </div>
                            </div>
                            <div class="col border-right" data-toggle="tooltip" title="female">
                                <div class="input-group">
                                    ...
                                    <input id="total_pwd_1st_female" name="total_pwd_1st_female" class="form-control" type="number" min="0">
                                </div>
                            </div>
                            ...
                            <div class="col" data-toggle="tooltip" title="male">
                                <div class="input-group">
                                    ...
                                    <input id="total_pwd_2nd_male" name="total_pwd_2nd_male" class="form-control" type="number" min="0">
                                </div>
                            </div>
                            <div class="col border-right" data-toggle="tooltip" title="female">
                                <div class="input-group">
                                    ...
                                    <input id="total_pwd_2nd_female" name="total_pwd_2nd_female" class="form-control" type="number" min="0">
                                </div>
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col" data-toggle="tooltip" title="male">
                                <div class="input-group">
                                    ...
                                    <input id="total_ip_1st_male" name="total_ip_1st_male" class="form-control" type="number" min="0">
                                </div>
                            </div>
                            <div class="col border-right" data-toggle="tooltip" title="female">
                                <div class="input-group">
                                    ...
                                    <input id="total_ip_1st_female" name="total_ip_1st_female" class="form-control" type="number" min="0">
                                </div>
                            </div>
                            ...
                            <div class="col" data-toggle="tooltip" title="male">
                                <div class="input-group">
                                    ...
                                    <input id="total_ip_2nd_male" name="total_ip_2nd_male" class="form-control" type="number" min="0">
                                </div>
                            </div>
                            <div class="col border-right" data-toggle="tooltip" title="female">
                                <div class="input-group">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col" data-toggle="tooltip" title="male">
                                <div class="input-group">
                                    ...
                                    <input id="total_with_board_1st_male" name="total_with_board_1st_male" class="form-control" type="number" min="0">
                                </div>
                            </div>
                            <div class="col border-right" data-toggle="tooltip" title="female">
                                <div class="input-group">
                                    ...
                                    <input id="total_with_board_1st_female" name="total_with_board_1st_female" class="form-control" type="number" min="0">
                                </div>
                            </div>
                            ...
                            <div class="col" data-toggle="tooltip" title="male">
                                <div class="input-group">
                                    ...
                                    <input id="total_with_board_2nd_male" name="total_with_board_2nd_male" class="form-control" type="number" min="0">
                                </div>
                            </div>
                            <div class="col border-right" data-toggle="tooltip" title="female">
                                <div class="input-group">
                ...
                <div class="modal-body">
                    <div class="form-group"><label>Degree Program</label>
                        <select name="tdp_program_name" id="tdp_program_name" class="form-control" required>
                            ...
                            AND (total_tdp_1sem_1yr_male = 0 AND total_tdp_1sem_1yr_female = 0 AND total_tdp_1sem_2yr_male = 0 AND total_tdp_1sem_2yr_female = 0 AND total_tdp_1sem_3yr_male = 0 AND total_tdp_1sem_3yr_female = 0 AND total_tdp_1sem_4yr_male = 0 AND total_tdp_1sem_4yr_female = 0 AND total_tdp_1sem_5yr_male = 0 AND total_tdp_1sem_5yr_female = 0 AND total_tdp_1sem_5yr_male = 0 AND total_tdp_1sem_5yr_female = 0 AND total_tdp_1sem_6yr_male = 0 AND total_tdp_1sem_6yr_female = 0) 
                            AND (total_tdp_2sem_1yr_male = 0 AND total_tdp_2sem_1yr_female = 0 AND total_tdp_2sem_2yr_male = 0 AND total_tdp_2sem_2yr_female = 0 AND total_tdp_2sem_3yr_male = 0 AND total_tdp_2sem_3yr_female = 0 AND total_tdp_2sem_4yr_male = 0 AND total_tdp_2sem_4yr_female = 0 AND total_tdp_2sem_5yr_male = 0 AND total_tdp_2sem_5yr_female = 0 AND total_tdp_2sem_5yr_male = 0 AND total_tdp_2sem_5yr_female = 0 AND total_tdp_2sem_6yr_male = 0 AND total_tdp_2sem_6yr_female = 0) 
                            AND (total_tdp_3sem_1yr_male = 0 AND total_tdp_3sem_1yr_female = 0 AND total_tdp_3sem_2yr_male = 0 AND total_tdp_3sem_2yr_female = 0 AND total_tdp_3sem_3yr_male = 0 AND total_tdp_3sem_3yr_female = 0 AND total_tdp_3sem_4yr_male = 0 AND total_tdp_3sem_4yr_female = 0 AND total_tdp_3sem_5yr_male = 0 AND total_tdp_3sem_5yr_female = 0 AND total_tdp_3sem_5yr_male = 0 AND total_tdp_3sem_5yr_female = 0 AND total_tdp_3sem_6yr_male = 0 AND total_tdp_3sem_6yr_female = 0) 
                            AND (total_tdp_sum_mid_1yr_male = 0 AND total_tdp_sum_mid_1yr_female = 0 AND total_tdp_sum_mid_2yr_male = 0 AND total_tdp_sum_mid_2yr_female = 0 AND total_tdp_sum_mid_3yr_male = 0 AND total_tdp_sum_mid_3yr_female = 0 AND total_tdp_sum_mid_4yr_male = 0 AND total_tdp_sum_mid_4yr_female = 0 AND total_tdp_sum_mid_5yr_male = 0 AND total_tdp_sum_mid_5yr_female = 0 AND total_tdp_sum_mid_5yr_male = 0 AND total_tdp_sum_mid_5yr_female = 0 AND total_tdp_sum_mid_6yr_male = 0 AND total_tdp_sum_mid_6yr_female = 0) 
                            AND (total_tdp_graduated_male = 0 AND total_tdp_graduated_female = 0) 
                            AND (total_tdp_exceeded_mrr_male = 0 AND total_tdp_exceeded_mrr_female = 0)";
                            $result = mysqli_query($conn, $sql);
                            $resultCheck = mysqli_num_rows($result);
                                ...
                                <div class="col border-right">
                                    <div class="form-group">
                                        <div class="form-row">
                                            <div class="col" data-toggle="tooltip" title="male">
                                                <div class="input-group">
                                                    <div class="input-group-prepend"><span class="input-group-text icon-container"><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-row">
                                            <div class="col" data-toggle="tooltip" title="female">
                                                <div class='input-group'>
                                                    <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div>
...
<!--Edit Program FHE-->
<div class="modal fade" role="dialog" tabindex="-1" id="add_program_fhe_modal">
    <div class="modal-dialog modal-xl" role="document">
            ...
            <form method="POST" id="add_program_fhe_form">
                ...
                <div class="modal-body">
                    ...
                    if ($ac_calendar == 'Trimester' or $ac_calendar == 'Trimester with Summer') {
                                        ...
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='male'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div>
                                                        <input name='total_fhe_1sem_1yr_male' id='total_fhe_1sem_1yr_male' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='female'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div>
                                                        <input name='total_fhe_1sem_1yr_female' id='total_fhe_1sem_1yr_female' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='male'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div>
                                                        <input name='total_fhe_1sem_2yr_male' id='total_fhe_1sem_2yr_male' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='female'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div>
                                                        <input name='total_fhe_1sem_2yr_female' id='total_fhe_1sem_2yr_female' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class='col border-right'>
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='male'>
                                                    <div class='input-group'>
                                                        <di 6v class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div>
                                                        <input name='total_fhe_1sem_3yr_male' id='total_fhe_1sem_3yr_male' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='female'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div>
                                                        <input name='total_fhe_1sem_3yr_female' id='total_fhe_1sem_3yr_female' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='male'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div>
                                                        <input name='total_fhe_1sem_4yr_male' id='total_fhe_1sem_4yr_male' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='female'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div>
                                                        <input name='total_fhe_1sem_4yr_female' id='total_fhe_1sem_4yr_female' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='male'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div>
                                                        <input name='total_fhe_1sem_5yr_male' id='total_fhe_1sem_5yr_male' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='female'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div>
                                                        <input name='total_fhe_1sem_5yr_female' id='total_fhe_1sem_5yr_female' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='male'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div>
                                                        <input name='total_fhe_1sem_6yr_male' id='total_fhe_1sem_6yr_male' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='female'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div>
                                                        <input name='total_fhe_1sem_6yr_female' id='total_fhe_1sem_6yr_female' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='male'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div>
                                                        <input name='total_fhe_2sem_1yr_male' id='total_fhe_2sem_1yr_male' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='female'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div>
                                                        <input name='total_fhe_2sem_1yr_female' id='total_fhe_2sem_1yr_female' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='male'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div>
                                                        <input name='total_fhe_2sem_2yr_male' id='total_fhe_2sem_2yr_male' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='female'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div>
                                                        <input name='total_fhe_2sem_2yr_female' id='total_fhe_2sem_2yr_female' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='male'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div>
                                                        <input name='total_fhe_2sem_3yr_male' id='total_fhe_2sem_3yr_male' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='female'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div>
                                                        <input name='total_fhe_2sem_3yr_female' id='total_fhe_2sem_3yr_female' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='male'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div>
                                                        <input name='total_fhe_2sem_4yr_male' id='total_fhe_2sem_4yr_male' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='female'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div>
                                                        <input name='total_fhe_2sem_4yr_female' id='total_fhe_2sem_4yr_female' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='male'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div>
                                                        <input name='total_fhe_2sem_5yr_male' id='total_fhe_2sem_5yr_male' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='female'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div>
                                                        <input name='total_fhe_2sem_5yr_female' id='total_fhe_2sem_5yr_female' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='male'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div>
                                                        <input name='total_fhe_2sem_6yr_male' id='total_fhe_2sem_6yr_male' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='female'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div>
                                                        <input name='total_fhe_2sem_6yr_female' id='total_fhe_2sem_6yr_female' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='male'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div>
                                                        <input name='total_fhe_3sem_1yr_male' id='total_fhe_3sem_1yr_male' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='female'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div>
                                                        <input name='total_fhe_3sem_1yr_female' id='total_fhe_3sem_1yr_female' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='male'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div>
                                                        <input name='total_fhe_3sem_2yr_male' id='total_fhe_3sem_2yr_male' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='female'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div>
                                                        <input name='total_fhe_3sem_2yr_female' id='total_fhe_3sem_2yr_female' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='male'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div>
                                                        <input name='total_fhe_3sem_3yr_male' id='total_fhe_3sem_3yr_male' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='female'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div>
                                                        <input name='total_fhe_3sem_3yr_female' id='total_fhe_3sem_3yr_female' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='male'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div>
                                                        <input name='total_fhe_3sem_4yr_male' id='total_fhe_3sem_4yr_male' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='female'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div>
                                                        <input name='total_fhe_3sem_4yr_female' id='total_fhe_3sem_4yr_female' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='male'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div>
                                                        <input name='total_fhe_3sem_5yr_male' id='total_fhe_3sem_5yr_male' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='female'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div>
                                                        <input name='total_fhe_3sem_5yr_female' id='total_fhe_3sem_5yr_female' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='male'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div>
                                                        <input name='total_fhe_3sem_6yr_male' id='total_fhe_3sem_6yr_male' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class='form-group'>
                                            <div class='form-row'>
                                                <div class='col' data-toggle='tooltip' title='female'>
                                                    <div class='input-group'>
                                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div>
                                                        <input name='total_fhe_3sem_6yr_female' id='total_fhe_3sem_6yr_female' class='form-control' type='number' min='0'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-row">
                                            <div class="col" data-toggle="tooltip" title="male">
                                                <div class="input-group">
                                                    <div class="input-group-prepend"><span class="input-group-text icon-container"><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div>
                                                    <input name="total_fhe_sum_mid_1yr_male" id="total_fhe_sum_mid_1yr_male" class="form-control" type="number" min="0">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-row">
                                            <div class="col" data-toggle="tooltip" title="female">
                                                <div class='input-group'>
                                                    <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div>
                                                    <input name="total_fhe_sum_mid_1yr_female" id="total_fhe_sum_mid_1yr_female" class="form-control" type="number" min="0">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-row">
                                            <div class="col" data-toggle="tooltip" title="male">
                                                <div class="input-group">
                                                    <div class="input-group-prepend"><span class="input-group-text icon-container"><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div>
                                                    <input name="total_fhe_sum_mid_2yr_male" id="total_fhe_sum_mid_2yr_male" class="form-control" type="number" min="0">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-row">
                                            <div class="col" data-toggle="tooltip" title="female">
                                                <div class='input-group'>
                                                    <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div>
                                                    <input name="total_fhe_sum_mid_2yr_female" id="total_fhe_sum_mid_2yr_female" class="form-control" type="number" min="0">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-row">
                                            <div class="col" data-toggle="tooltip" title="male">
                                                <div class="input-group">
                                                    <div class="input-group-prepend"><span class="input-group-text icon-container"><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div>
                                                    <input name="total_fhe_sum_mid_3yr_male" id="total_fhe_sum_mid_3yr_male" class="form-control" type="number" min="0">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-row">
                                            <div class="col" data-toggle="tooltip" title="female">
                                                <div class='input-group'>
                                                    <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div>
                                                    <input name="total_fhe_sum_mid_3yr_female" id="total_fhe_sum_mid_3yr_female" class="form-control" type="number" min="0">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-row">
                                            <div class="col" data-toggle="tooltip" title="male">
                                                <div class="input-group">
                                                    <div class="input-group-prepend"><span class="input-group-text icon-container"><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div>
                                                    <input name="total_fhe_sum_mid_4yr_male" id="total_fhe_sum_mid_4yr_male" class="form-control" type="number" min="0">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-row">
                                            <div class="col" data-toggle="tooltip" title="female">
                                                <div class='input-group'>
                                                    <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div>
                                                    <input name="total_fhe_sum_mid_4yr_female" id="total_fhe_sum_mid_4yr_female" class="form-control" type="number" min="0">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-row">
                                            <div class="col" data-toggle="tooltip" title="male">
                                                <div class="input-group">
                                                    <div class="input-group-prepend"><span class="input-group-text icon-container"><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div>
                                                    <input name="total_fhe_sum_mid_5yr_male" id="total_fhe_sum_mid_5yr_male" class="form-control" type="number" min="0">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-row">
                                            <div class="col" data-toggle="tooltip" title="female">
                                                <div class='input-group'>
                                                    <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div>
                                                    <input name="total_fhe_sum_mid_5yr_female" id="total_fhe_sum_mid_5yr_female" class="form-control" type="number" min="0">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-row">
                                            <div class="col" data-toggle="tooltip" title="male">
                                                <div class="input-group">
                                                    <div class="input-group-prepend"><span class="input-group-text icon-container"><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div>
                                                    <input name="total_fhe_sum_mid_6yr_male" id="total_fhe_sum_mid_6yr_male" class="form-control" type="number" min="0">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-row">
                                            <div class="col" data-toggle="tooltip" title="female">
                                                <div class='input-group'>
                                                    <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div>
                                                    <input name="total_fhe_sum_mid_6yr_female" id="total_fhe_sum_mid_6yr_female" class="form-control" type="number" min="0">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <hr>
                        <div class="form-group"><label>No. of FHE Grantees who graduated</label>
                            <div class="form-row">
                                <div class="col-xl-6" data-toggle="tooltip" title="male">
                                    <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text icon-container"><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div>
                                        <input name="total_fhe_graduated_male" id="total_fhe_graduated_male" class="form-control" type="number" min="0">
                                    </div>
                                </div>
                                <div class="col-xl-6" data-toggle="tooltip" title="female">
                                    <div class='input-group'>
                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div>
                                        <input name="total_fhe_graduated_female" id="total_fhe_graduated_female" class="form-control" type="number" min="0">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <hr>
                        <div class="form-group"><label>No. of FHE Grantees who exceeded the maximum residency rule</label>
                            <div class="form-row">
                                <div class="col-xl-6" data-toggle="tooltip" title="male">
                                    <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text icon-container"><i class='fas fa-male' style='font-size:20px; color:#1a5676'></i></span></div>
                                        <input name="total_fhe_exceeded_mrr_male" id="total_fhe_exceeded_mrr_male" class="form-control" type="number" min="0">
                                    </div>
                                </div>
                                <div class="col-xl-6" data-toggle="tooltip" title="female">
                                    <div class='input-group'>
                                        <div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fas fa-female' style='font-size:20px; color:#9a0694'></i></span></div>
                                        <input name="total_fhe_exceeded_mrr_female" id="total_fhe_exceeded_mrr_female" class="form-control" type="number" min="0">
                                    </div>
                                </div>
                            </div>
                        </div>

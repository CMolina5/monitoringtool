...
$sql = "SELECT * FROM tbl_degree_programs 
WHERE hei_uii='$_SESSION[hei_uii]' AND ac_year='$_SESSION[ac_year]' AND  (total_fhe_1sem_1yr_male != 0 AND total_fhe_1sem_female != 0 AND total_fhe_2sem_male != 0 AND total_fhe_2sem_female != 0 AND total_fhe_3sem_male != 0)
ORDER BY program_name ASC";
$result = mysqli_query($conn, $sql);
$resultCheck = mysqli_num_rows($result);
if ($resultCheck > 0) {

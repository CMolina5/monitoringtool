...
$pdf->Cell(336, 5, 'WARNING: FOR REVIEWING PURPOSES ONLY! DO NOT PRINT THIS PAGE!', 0, 0, 'C', true);
$pdf->Ln();
$pdf->Ln();
...
if ($_SESSION['hei_it'] == 'Private HEI') {
    if($_SESSION['hei_pnsl'] == 1){
        $pdf->Cell(73, 5, 'Yes', 0, 0, 'L', true);
    }else{
        $pdf->Cell(73, 5, 'No', 0, 0, 'L', true);
    }
} else {
...
WHERE hei_uii='$_SESSION[hei_uii]' AND ac_year='$_SESSION[ac_year]' AND  (total_fhe_1sem_1yr_male != 0 OR total_fhe_1sem_1yr_female != 0 OR total_fhe_1sem_2yr_male != 0 OR total_fhe_1sem_2yr_female != 0 OR total_fhe_1sem_3yr_male != 0 OR total_fhe_1sem_3yr_female != 0 OR total_fhe_1sem_4yr_male != 0 OR total_fhe_1sem_4yr_female != 0 OR total_fhe_1sem_5yr_male != 0 OR total_fhe_1sem_5yr_female != 0 OR total_fhe_1sem_6yr_male != 0 OR total_fhe_1sem_6yr_female != 0 OR 
total_fhe_2sem_1yr_male != 0 OR total_fhe_2sem_1yr_female != 0 OR total_fhe_2sem_2yr_male != 0 OR total_fhe_2sem_2yr_female != 0 OR total_fhe_2sem_3yr_male != 0 OR total_fhe_2sem_3yr_female != 0 OR total_fhe_2sem_4yr_male != 0 OR total_fhe_2sem_4yr_female != 0 OR total_fhe_2sem_5yr_male != 0 OR total_fhe_2sem_5yr_female != 0 OR total_fhe_2sem_6yr_male != 0 OR total_fhe_2sem_6yr_female != 0 OR
total_fhe_3sem_1yr_male != 0 OR total_fhe_3sem_1yr_female != 0 OR total_fhe_3sem_2yr_male != 0 OR total_fhe_3sem_2yr_female != 0 OR total_fhe_3sem_3yr_male != 0 OR total_fhe_3sem_3yr_female != 0 OR total_fhe_3sem_4yr_male != 0 OR total_fhe_3sem_4yr_female != 0 OR total_fhe_3sem_5yr_male != 0 OR total_fhe_3sem_5yr_female != 0 OR total_fhe_3sem_6yr_male != 0 OR total_fhe_3sem_6yr_female != 0 OR
total_fhe_sum_mid_1yr_male != 0 OR total_fhe_sum_mid_1yr_female != 0 OR total_fhe_sum_mid_2yr_male != 0 OR total_fhe_sum_mid_2yr_female != 0 OR total_fhe_sum_mid_3yr_male != 0 OR total_fhe_sum_mid_3yr_female != 0 OR total_fhe_sum_mid_4yr_male != 0 OR total_fhe_sum_mid_4yr_female != 0 OR total_fhe_sum_mid_5yr_male != 0 OR total_fhe_sum_mid_5yr_female != 0 OR total_fhe_sum_mid_6yr_male != 0 OR total_fhe_sum_mid_6yr_female != 0)
...
ORDER BY program_name ASC";
    ...
    if ($resultCheck > 0) {
        ...
        $sql = "SELECT *,
    SUM(total_fhe_1st_male) AS grand_total_fhe_1st_male, 
    SUM(total_fhe_1st_female) AS grand_total_fhe_1st_female,
    SUM(total_fhe_2nd_male) AS grand_total_fhe_2nd_male, 
    SUM(total_fhe_2nd_female) AS grand_total_fhe_2nd_female,
    SUM(total_fhe_3rd_male) AS grand_total_fhe_3rd_male, 
    SUM(total_fhe_3rd_female) AS grand_total_fhe_3rd_female,
    SUM(total_fhe_sum_mid_male) AS grand_total_fhe_sum_mid_male, 
    SUM(total_fhe_sum_mid_female) AS grand_total_fhe_sum_mid_female
    FROM tbl_fhe_category 
    WHERE hei_uii='$_SESSION[hei_uii]' AND ac_year='$_SESSION[ac_year]'";
        $result = mysqli_query($conn, $sql);
        $resultCheck = mysqli_num_rows($result);
        if ($resultCheck > 0) {
            while ($row = mysqli_fetch_assoc($result)) {
                //1st Semester
                $grand_total_fhe_1st_male = $row['grand_total_fhe_1st_male'];
                $grand_total_fhe_1st_female = $row['grand_total_fhe_1st_female'];

                //2nd Semester
                $grand_total_fhe_2nd_male = $row['grand_total_fhe_2nd_male'];
                $grand_total_fhe_2nd_female = $row['grand_total_fhe_2nd_female'];

                //3rd Semester
                $grand_total_fhe_3rd_male = $row['grand_total_fhe_3rd_male'];
                $grand_total_fhe_3rd_female = $row['grand_total_fhe_3rd_female'];

                //Summer Midyear
                $grand_total_fhe_sum_mid_male = $row['grand_total_fhe_sum_mid_male'];
                $grand_total_fhe_sum_mid_female = $row['grand_total_fhe_sum_mid_female'];
            }
        }
        //FIRST ROW
        $pdf->SetFont('Arial', 'B', 10);
        ...
        $pdf->Cell(37, 5, $grand_total_fhe_2nd_female, 1, 0, 'C', true);
        if ($ac_calendar == 'Trimester' || $ac_calendar == 'Trimester with Summer') {
            $pdf->Cell(37, 5, $grand_total_fhe_3rd_male, 1, 0, 'C', true);
    ...
    if ($resultCheck > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            if ($ac_calendar == 'Trimester' || $ac_calendar == 'Trimester with Summer') {
                ...
                $pdf->Cell(19.75, 5, 'N/A', 1, 0, 'C', true);
                $pdf->Cell(19.75, 5, 'N/A', 1, 0, 'C', true);
                $pdf->Cell(19.75, 5, 'N/A', 1, 0, 'C', true);
                $pdf->Cell(19.75, 5, 'N/A', 1, 0, 'C', true);
            }

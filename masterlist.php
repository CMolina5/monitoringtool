...
$pdf->Cell(80.25, 5, $total_undergraduate_1st_female + $total_undergraduate_1st_male, 1, 0, 'C', true);
$pdf->Cell(80.25, 5, $total_undergraduate_2nd_female, 1, 0, 'C', true);
$pdf->Cell(80.25, 5, $total_undergraduate_2nd_female + $total_undergraduate_2nd_male, 1, 0, 'C', true);
$pdf->Cell(80.25, 5, $total_undergraduate_3rd_female, 1, 0, 'C', true);
$pdf->Cell(80.25, 5, $total_undergraduate_3rd_female + $total_undergraduate_3rd_male, 1, 0, 'C', true);
$pdf->Cell(80.25, 5, $total_undergraduate_summer_midyear_female, 1, 0, 'C', true);
$pdf->Cell(80.25, 5, $total_undergraduate_4th_female + $total_undergraduate_4th_male, 1, 0, 'C', true);
$pdf->Ln();
$pdf->Ln();

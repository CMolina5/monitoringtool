    ...
    <form method="POST" action="includes/heiprofile/inc_add_hei_profile.php" class="needs-validation" novalidate>
        <div class="card card-style-out">
            ...
            <div class="card card-style">
                ...
                <div class="form-group"><label>Contact Number</label><label class="text-danger" title="required">&nbsp;*</label>
                    <div class="input-group">
                        <div class="input-group-prepend"><span class="input-group-text"><i class="fas fa-phone-alt icons-input"></i></span></div><input name="hei_contact_no" class="form-control" type="tel" pattern="^(09)\d{9}$" value="<?php echo $hei_contact_no ?>" required="" placeholder="(09)(9 digit phone number)">
                        <div class="input-group-prepend"></div>
                        <div class="invalid-feedback">
                ...
                <div class="form-group"><label>Alternative Contact Number</label>
                    <div class="input-group">
                        <div class="input-group-prepend"><span class="input-group-text"><i class="fas fa-phone-alt icons-input"></i></span></div><input name="hei_alt_contact_no" class="form-control" type="tel" pattern="^(09)\d{9}$" placeholder="(09)(9 digit phone number)" value="<?php echo $hei_alt_contact_no ?>">
                        <div class="input-group-prepend"></div>
                        <div class="invalid-feedback">
                            Please enter a valid contact number.
                        </div>
            ...
            <div class="card card-style">
                ...
                <div class="form-group"><label>Name of the Head of HEI</label><label class="text-danger" title="required">&nbsp;*</label>
                    <div class="input-group">
                        <div class="input-group-prepend"><span class="input-group-text"><i class="fas fa-user icons-input"></i></span></div><input name="hei_head_name" class="form-control" type="text" placeholder="Firstname   Middlename   Lastname" value="<?php echo iconv("UTF-8", "ISO-8859-1//IGNORE",$hei_head_name) ?>" required>
                    </div>
                    <div class="invalid-feedback">
                ...
                <div class="form-group"><label>Contact Number</label><label class="text-danger" title="required">&nbsp;*</label>
                    <div class="input-group">
                        <div class="input-group-prepend"><span class="input-group-text"><i class="fas fa-phone-alt icons-input"></i></span></div><input name="hei_head_contact_no" class="form-control" type="tel" pattern="^(09)\d{9}$" value="<?php echo $hei_head_contact_no ?>" required="" placeholder="(09)(9 digit phone number)">
                        <div class="input-group-prepend"></div>
                        <div class="invalid-feedback">
                            Please enter a valid contact number.
                        </div>
                ...
                <div class="form-group"><label>Alternative Contact Number</label>
                    <div class="input-group">
                        <div class="input-group-prepend"><span class="input-group-text"><i class="fas fa-phone-alt icons-input"></i></span></div><input name="hei_head_alt_contact_no" class="form-control" type="tel" pattern="^(09)\d{9}$" value="<?php echo $hei_head_alt_contact_no ?>" placeholder="(09)(9 digit phone number)">
                        <div class="input-group-prepend"></div>
                        <div class="invalid-feedback">
                            Please enter a valid contact number.
                        </div>
            ...
            if ($fhe == 'yes') {
                ...
                <div class='form-group'><label>Contact Number</label><label class='text-danger' title='required'>&nbsp;*</label>
                    <div class='input-group'>
                        <div class='input-group-prepend'><span class='input-group-text'><i class='fas fa-phone-alt icons-input'></i></span></div><input name='fhe_focal_contact_no' class='form-control' type='tel' pattern='^(09)\d{9}$' placeholder='(09)(9 digit phone number)' value='$fhe_focal_contact_no' required=''>
                        <div class='input-group-prepend'></div>
                        <div class='invalid-feedback'>
                            Please enter a valid contact number.
                        </div>
                ...
                <div class='form-group'><label>Alternative Contact Number</label>
                    <div class='input-group'>
                        <div class='input-group-prepend'><span class='input-group-text'><i class='fas fa-phone-alt icons-input'></i></span></div><input name='fhe_focal_alt_contact_no' class='form-control' type='tel' pattern='^(09)\d{9}$' placeholder='(09)(9 digit phone number)' value='$fhe_focal_alt_contact_no'>
                        <div class='input-group-prepend'></div>
                        <div class='invalid-feedback'>
                            Please enter a valid contact number.
                        </div>
            ...
            if ($tes == 'yes') {
                ...
                <div class='form-group'><label>Contact Number</label><label class='text-danger' title='required'>&nbsp;*</label>
                    <div class='input-group'>
                        <div class='input-group-prepend'><span class='input-group-text'><i class='fas fa-phone-alt icons-input'></i></span></div><input name='tes_focal_contact_no' class='form-control' type='tel' pattern='^(09)\d{9}$' placeholder='(09)(9 digit phone number)' value='$tes_focal_contact_no' required=''>
                        <div class='input-group-prepend'></div>
                        <div class='invalid-feedback'>
                            Please enter a valid contact number.
                        </div>
                ...
                <div class='form-group'><label>Alternative Contact Number</label>
                    <div class='input-group'>
                        <div class='input-group-prepend'><span class='input-group-text'><i class='fas fa-phone-alt icons-input'></i></span></div><input name='tes_focal_alt_contact_no' class='form-control' type='tel' pattern='^(09)\d{9}$' placeholder='(09)(9 digit phone number)' value='$tes_focal_alt_contact_no'>
                        <div class='input-group-prepend'></div>
                        <div class='invalid-feedback'>
                            Please enter a valid contact number.
                        </div>
            ...
            if ($tdp == 'yes') {
                echo "<div class='card card-style'>
                    ...
                    <div class='form-group'><label>Contact Number</label><label class='text-danger' title='required'>&nbsp;*</label>
                        <div class='input-group'>
                            <div class='input-group-prepend'><span class='input-group-text'><i class='fas fa-phone-alt icons-input'></i></span></div><input name='tdp_focal_contact_no' class='form-control' type='tel' pattern='^(09)\d{9}$' placeholder='(09)(9 digit phone number)' value='$tdp_focal_contact_no' required=''>
                            <div class='input-group-prepend'></div>
                            <div class='invalid-feedback'>
                                Please enter a valid contact number.
                            </div>
                    ...
                    <div class='form-group'><label>Alternative Contact Number</label>
                        <div class='input-group'>
                            <div class='input-group-prepend'><span class='input-group-text'><i class='fas fa-phone-alt icons-input'></i></span></div><input name='tdp_focal_alt_contact_no' class='form-control' type='tel' pattern='^(09)\d{9}$' placeholder='(09)(9 digit phone number)' value='$tdp_focal_alt_contact_no'>
                            <div class='input-group-prepend'></div>
                            <div class='invalid-feedback'>
                                Please enter a valid contact number.
                            </div>
            ...
            <div class="card card-style">
                ...
                <div class="form-group"><label>Enrollment Period</label>
                    <div id='enrollment_date' class="form-row">
                        ...
                        <div class="input-group">
                            <div class="input-group-prepend"><span class="input-group-text icon-container"><i class="fa fa-calendar-o"></i></span></div><input class="form-control date-size" id="picker" name="enrollment_1st" type="text" placeholder="MM/DD/YYYY-MM/DD/YYYY" value="<?php echo $enrollment_period_1st ?>" required="" onkeydown="return false;" autocomplete="off">
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend"><span class="input-group-text icon-container"><i class="fa fa-calendar-o"></i></span></div><input class="form-control date-size" id="picker2" name="enrollment_2nd" type="text" placeholder='MM/DD/YYYY-MM/DD/YYYY' value="<?php echo $enrollment_period_2nd ?>" required="" onkeydown="return false;" autocomplete="off">
                    </div>
                </div>
                <script>
                ...
                if ($ac_calendar == 'Trimester' or $ac_calendar == 'Trimester with Summer') {
                    ...
                    echo "
                            ...
                            <div class='input-group'><div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fa fa-calendar-o'></i></span></div><input class='form-control date-size' id='picker3' name='enrollment_3rd' type='text' placeholder='MM/DD/YYYY-MM/DD/YYYY' value='$enrollment_period_3rd' required='' onkeydown='return false;' autocomplete='off'>
                            </div>
                        </div>
                        <script>
                ...
                if ($ac_calendar == 'Semester with Summer' or $ac_calendar == 'Trimester with Summer') {
                    ...
                    echo "
                            ...
                            <div class='input-group'><div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fa fa-calendar-o'></i></span></div><input class='form-control date-size' id='picker4' name='enrollment_summer_midyear' type='text' placeholder='MM/DD/YYYY-MM/DD/YYYY' value='$enrollment_period_summer_midyear' required='' onkeydown='return false;' autocomplete='off'>
                            </div>
                        </div>
                        <script>
        ...
        <div class="form-group"><label>Opening of Classes</label>
            <div class="form-row">
                ...
                <label>1st Term</label><label class='text-danger' title='required'>&nbsp;*</label>
                <div class="input-group">
                    <div class="input-group-prepend"><span class="input-group-text icon-container"><i class="fa fa-calendar-o"></i></span></div><input class="form-control date-size" id="picker5" name="opening_1st" type="text" placeholder='MM/DD/YYYY' value="<?php echo  $opening_of_classes_1st ?>" required="" onkeydown='return false;' autocomplete='off'>
                </div>
                <script>
            ...
            <label>2nd Term</label><label class='text-danger' title='required'>&nbsp;*</label>
            <div class="input-group">
                <div class="input-group-prepend"><span class="input-group-text icon-container"><i class="fa fa-calendar-o"></i></span></div><input class="form-control date-size" id="picker6" name="opening_2nd" type="text" placeholder='MM/DD/YYYY' value="<?php echo  $opening_of_classes_2nd ?>" required="" onkeydown='return false;' autocomplete='off'>
            </div>
            <script>
        ...
        if ($ac_calendar == 'Trimester' or $ac_calendar == 'Trimester with Summer') {
            ...
            echo "
                            <label>3rd Term</label><label class='text-danger' title='required'>&nbsp;*</label>
                            <div class='input-group'><div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fa fa-calendar-o'></i></span></div><input class='form-control date-size' id='picker7' name='opening_3rd' type='text' placeholder='MM/DD/YYYY' value='$opening_of_classes_3rd' required='' onkeydown='return false;' autocomplete='off'>
                            </div>
                            <script>
        ...
        if ($ac_calendar == 'Semester with Summer' or $ac_calendar == 'Trimester with Summer') {
            ...
            echo "
                            <label>Summer/Midyear</label><label class='text-danger' title='required'>&nbsp;*</label>
                            <div class='input-group'><div class='input-group-prepend'><span class='input-group-text icon-container'><i class='fa fa-calendar-o'></i></span></div><input class='form-control date-size' id='picker8' name='opening_summer_midyear' type='text' placeholder='MM/DD/YYYY' value='$opening_of_classes_summer_midyear' required='' onkeydown='return false;' autocomplete='off'>   
                            </div>
                            <script>
...
<div class="card card-style">
    <div class="form-group"><label class="label-parts">I.E OTHER LOCALLY-AND-NATIONALLY-FUNDED STUFAPS</label><label style="font-style: italic;">List all locally- and nationally-funded StuFAPs availed in the institution, if any. Indicate the corresponding number of beneficiaries per year level.</label>
